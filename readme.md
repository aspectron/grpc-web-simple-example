...
in the current directory:
 ...
 - `protos/kaspad_pb.js`: this contains the `UTXO`, `UTXOsRequest`, `UTXOsReply`, `HelloRequest`, `HelloReply`
   classes
 - `protos/kaspad_grpc_web_pb.js`: this contains the `RPCClient` class
...
>
```sh
$ docker run --name="kaspad" -d -v "$(pwd)"/envoy.yaml:/etc/envoy/envoy.yaml:ro \
